...
const Login = ({ url }) => {
    ...
    return (
        <div className={`min-h-[700px] w-screen md:p-14 md:h-[90%] flex justify-center items-center`}>
            <div className={`md:w-[30%] w-[90%] h-[400px] bg-slate-800 grid grid-row-3 place-items-center`}>
                <div className={`flex justify-center items-center text-white text-[32px] md:p-2`}>Login</div>
                <div className={`w-[70%] h-[30px] flex flex-col justify-center`}>
                    <div className={`mb-5 w-full`}>
                        <label
                            htmlFor={'username'}
                            className={`text-white w-[100px] justify-between flex items-center mb-2`}
                        >
                            <UserCircleIcon className={`w-4 h-4`}/>Username:
                        </label>
                        <input
                            id={'username'}
